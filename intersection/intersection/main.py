...
# TODO: before changing anything, research the random library and
# types annotations in the function signature!
# https://docs.python.org/3/library/typing.html#typing.Union
# https://docs.python.org/3.9/library/typing.html#special-forms
# https://docs.python.org/3/library/random.html
# NOTE: check out the urls....they all start with docs.python.org...good info!
def fill_random_container(
    size: int, maximum: int, make_tuple: bool = False
) -> Union[List[int], Tuple[int, ...]]:
    """Generate a random container defined by the size and with no number bigger than maximum."""
    # TODO: Reference: Chapter 5 List Comprehension
    # TODO: please implement this function using a list comprehension
    # NOTE: the values inside the container should be random integers
    # NOTE: the largest number inside is governed by `maximum`
    # NOTE: the quantity of numbers inside is governed by `size`
    # NOTE: the container can always start out as a list
    ...
    # TODO: replace this placeholder return
    return [1,2,3,4,5]
